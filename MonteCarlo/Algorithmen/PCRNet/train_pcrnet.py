...
def main():
	...
	trainset = RegistrationData('PCRNet', ModelNet40Data(train=True, download=False, num_points=1024))
	testset = RegistrationData('PCRNet', ModelNet40Data(train=False, download=False, num_points=1024))
